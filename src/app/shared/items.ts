...
export const ITEMS: Item[] = [
  {
    ...
    imageList: ['/assets/images/tractorkubota.jpg'],
    category: 'machinery',
    label: 'tractor',
    price: '4.500',
  ...
  },
  {
    ...
    imageList: ['/assets/images/tractorkubota-pala.jpg'],
    category: 'machinery',
    label: 'tractor',
    price: '10.500',
  ...
  },
  {
    ...
    imageList: ['/assets/images/motocultor.jpg'],
    category: 'machinery',
    label: 'motocultor',
    price: '2.500',
  ...
  },
  {
    ...
    featured: false,
    name: 'Montacarga',
    imageList: ['/assets/images/montacarga.jpg'],
    category: 'machinery',
    label: '',
    price: '15.999',
